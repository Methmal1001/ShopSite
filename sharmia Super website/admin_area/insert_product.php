...
if(isset($_POST['insert_product'])){
    ...
    || empty($product_price) || empty($product_status) || empty($product_image1) || empty($product_image2) || empty($product_image3)){
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="status" id="status" class="form-control" placeholder="Enter product status" 
                autocomplete="off" required="required">
            </div>
