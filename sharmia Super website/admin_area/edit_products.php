...
<div class="container mt-5">
    ...
    while ($row_category_all = mysqli_fetch_assoc($result_category_all)) {
        ...
        echo "<option value='$category_id_all' $selected>$category_title_all</option>";
    };
    ?>
    ...
    while ($row_brand_all = mysqli_fetch_assoc($result_brand_all)) {
        ...
        $selected = ($brand_id_all == $brand_id) ? 'selected' : '';
        echo "<option value='$brand_id_all' $selected>$brand_title_all</option>";
    };
    ?>
            </select>
        </div>
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="status" class="form-lable">Product Status</label>
            <input type="text" id="status" value="<?php echo $product_status?>" name="status" class="form-control" required="required">
        </div>
...
if(isset($_POST['edit_product'])){
    ...
    if($product_title=='' or $product_desc=='' or $product_keywords=='' or $product_category=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3==''
     or $product_price=='' or $product_status==''){
        ...
        product_image1='$product_image1', product_image2='$product_image2', product_image3='$product_image3', product_price='$product_price', status='$product_status', date=NOW() WHERE product_id=$edit_id";
