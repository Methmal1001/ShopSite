...
if(isset($_POST['edit_product'])){
    ...
    or $product_email=='' or $product_contact=='' or $product_price==''){
        ...
        product_image1='$product_image1', product_image2='$product_image2', product_image3='$product_image3', product_email='$product_email', product_contact='$product_contact', product_price='$product_price', date=NOW() WHERE product_id=$edit_id";
